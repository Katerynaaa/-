...
public class Twentyfortyeight {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        int marker = 0;
        for (int j = 160; j <= 340; j = j + 60) {
            for (int i = 160; i <= 340; i = i + 60) {
                Tiles.add(new aTile(i, j));
                Tiles.get(marker).setSize(new Dimension(400, 400)); //поле закрашивания плитки
        ...
        Grid grid = new Grid();
        grid.setSize(new Dimension(401, 401));
        ...
        window.setSize(new Dimension(430, 450));
